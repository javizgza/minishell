...
SRCS =  ./src/execute/main.c ./src/execute/main_extra.c\
		...
		./src/execute/env/enviroment.c ./src/execute/env/execute.c ./src/execute/env/rediret.c ./src/execute/env/heredoc.c ./src/execute/env/find_env.c\
...
$(NAME): $(OBJTS)
	$(CC) $(CFLAGS) -o $(NAME) $(OBJTS) -l readline
