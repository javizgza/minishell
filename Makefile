...
SRCS =  ./src/execute/main.c\
		...
		./src/parsing/define_tokens.c ./src/parsing/lexer.c ./src/parsing/parser_utils2.c ./src/parsing/parser_utils.c ./src/parsing/redirections.c ./src/parsing/has_dollar.c ./src/parsing/signals.c
