...
SRCS =  ./execute/main.c\
		./libft/ft_strlen.c ./libft/ft_strjoin.c ./libft/ft_split.c ./libft/ft_substr.c ./libft/ft_strchr.c ./libft/ft_strncmp.c ./libft/ft_strlcat.c ./libft/ft_calloc.c ./libft/ft_bzero.c ./libft/ft_atoi.c ./libft/ft_strdup.c ./libft/ft_strlcpy.c ./libft/ft_memset.c\
